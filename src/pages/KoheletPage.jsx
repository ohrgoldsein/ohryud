...
import { Star, BookOpen, Crown, Globe, Youtube, Mail } from 'lucide-react';

export default function KoheletPage() {
    return (
        <div dir="rtl" className="font-[Tinos] text-[#1D2D50]">
            {/* Sticky Header */}
            <header className="fixed top-0 left-0 right-0 z-50 bg-[#E1C582]/90 backdrop-blur-sm shadow-md flex justify-between items-center px-12 py-4">
                <button
                    onClick={() => window.open("http://textratz.co.il/", "_blank")}
                    className="bg-[#b8860b] text-black font-semibold px-4 py-2 rounded-full hover:bg-[#d4a017] transition-colors"
                >
                    רכישה
                </button>
            ...
            {/* Hero Section */}
            <section id="hero" className="flex flex-col md:flex-row h-screen pt-20">
                {/* Left Section */}
                <div className="flex-1 bg-[#E1C582] flex flex-col justify-center px-16 relative overflow-hidden">
                    <Star className="absolute top-20 left-10 text-[#d4af37] opacity-20 w-10 h-10" />
                    <BookOpen className="absolute bottom-20 right-20 text-[#d4af37] opacity-20 w-12 h-12" />
                    <Crown className="absolute top-1/2 left-1/3 text-[#d4af37] opacity-10 w-20 h-20" />

                    <div className="max-w-xl z-10 text-justify leading-relaxed space-y-6">
                        <h1 className="text-6xl font-bold mb-8 leading-snug text-right">מגילת קהלת <br /> כפי שלא נראתה <br /> אף פעם.</h1>
                        <p className="text-[#3a3a4a] mb-10 text-xl leading-loose">
                            קריאה חדשה ומעמיקה במגילת קהלת, החושפת מאחורי סתירותיה את ליבת האמונה היהודית.
                            ד"ר אור י. גולדשטיין מציע פרשנות תורנית־הגותית המשלבת פילוסופיה, חסידות וחכמת העמים.
                        </p>
                        <div className="flex items-center gap-6">
                            <div className="text-xl text-[#b8860b]">
                                <div className="line-through text-gray-500">₪60</div>
                                <div className="text-3xl font-bold">₪45</div>
                            </div>
                            <button
                                onClick={() => window.open("http://textratz.co.il/", "_blank")}
                                className="bg-[#1D2D50] hover:bg-[#133B5C] text-[#f7e7b4] px-10 py-4 rounded-full shadow-2xl text-2xl transition-transform transform hover:scale-105">
                                לרכישה
                            </button>
                        </div>
                    </div>
                ...
                {/* Right Section */}
                <div className="flex-1 bg-[#0f162e] flex justify-center items-center relative overflow-hidden">
                    <motion.div
                    ...
                    >
                        <img
                            ...
                            alt="מגילת קהלת"
                            className="w-96 md:w-[28rem] rounded-lg shadow-[0_0_50px_rgba(184,134,11,0.5)] border-4 border-[#b8860b]"
                        />
                    </motion.div>
                </div>
            </section>
            ...
            {/* Section A - The Book */}
            <section id="book" className="flex flex-col md:flex-row h-screen">
                {/* Left Part */}
                <div className="flex-[1] bg-[#1E5F74] flex justify-center items-center p-8 ">
                    <iframe
                        className="rounded-2xl shadow-lg w-[300px] h-[533px] md:w-[360px] md:h-[640px]"
                ...
                {/* Right Part */}
                <div className="flex-[1.5] bg-[#133B5C] flex flex-col justify-center items-center p-12 text-center text-[#E1C582]">
                    <div className="text-xl leading-loose max-w-xl text-justify space-y-2">
            ...
            <section id="author" className="flex flex-col md:flex-row h-screen">
                {/* Left: Text */}
                <div className="flex-1 bg-[#1D2D50] text-[#b8860b] flex flex-col justify-center items-center p-12 text-center">
                    <p className="text-2xl max-w-lg leading-loose mb-6 text-justify">
                    ...
                    <div className="flex gap-6 text-[#b8860b] mt-4">
                        <a href="https://ohryud.vercel.app/" target="_blank" rel="noopener noreferrer"><Globe className="w-8 h-8 hover:scale-110 transition-transform" /></a>
                        <a href="https://www.youtube.com/@t.navoch" target="_blank" rel="noopener noreferrer"><Youtube className="w-8 h-8 hover:scale-110 transition-transform" /></a>
                        <a href="mailto:ohr.yud@gmail.com"><Mail className="w-8 h-8 hover:scale-110 transition-transform" /></a>
                    </div>
                </div>
                {/* Right: Photo */}
                <div className="flex-1 bg-[#0f162e] flex justify-center items-center p-8">
                    <img
                        src="/me.png"
                        alt="Author photo"
                        className="rounded-full w-64 h-64 object-cover shadow-[0_0_50px_rgba(184,134,11,0.4)] border-4 border-[#b8860b]"
                    />
                </div>
            </section>
            ...
            <section id="intro" className="flex flex-col md:flex-row h-screen">
                ...
                <div className="flex-1 bg-[#1E5F74] flex justify-center items-center p-8">
                    <img
                        src="/from_book.jpg"
                        alt="Intro image"
                        className="w-96 rounded-lg shadow-[0_0_50px_rgba(184,134,11,0.4)] border-4 border-[#b8860b]"
                    />
                </div>
                {/* Right */}
                <div className="flex-1 bg-[#133B5C] text-[#f7e7b4] flex flex-col justify-center items-center p-12">
                    <h2 className="text-4xl font-bold mb-6 text-[#b8860b]">מתוך ההקדמה</h2>
                    <div
                        className="max-h-80 overflow-y-auto bg-[#0f162e]/60 p-6 rounded-lg shadow-inner border border-[#b8860b]/30 text-lg leading-loose text-justify space-y-6">
                        {/* keep your long paragraphs here */}
            ...
            {/* Footer */}
            <footer className="bg-[#E1C582] text-center py-6 text-[#1D2D50] border-t border-[#284574]/40">
