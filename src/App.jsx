    ...
    <div dir="rtl" className="scroll-smooth flex min-h-screen bg-[#0f0f0f] text-gray-200 tinos-regular">
      ...
      <main className="flex-1 px-2 sm:px-6 md:px-10 space-y-0 h-screen overflow-y-scroll snap-none md:snap-y md:snap-mandatory">
        <div className="h-full">
          ...
          <section
            id="publications"
            className="relative scroll-mt-20 snap-start min-h-screen md:h-screen bg-[#1a1a1a] p-20 text-gray-300 border-t border-gray-800 transition-colors duration-500 ease-in-out overflow-y-auto"
          >
            <Publications />
