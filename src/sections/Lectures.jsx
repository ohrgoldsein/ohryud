...
const lectures = [
  {
    ...
    description:
      'AI במבט פילוסופי וספרותי. איפה בינה מלאכותית מוזכרת בתלמוד? האם ניתן להוכיח שכוחה של מכונה מוגבל? האם סופנו קרב? הרצאה שתשאיר אתכם עם הרהורים עמוקים לזמן רב.',  },
  {
  ...
  },
  {
    ...
    title: 'החצר האחורית',
    description:
'שעת סיפור חסידי אחרת. מה עשה האדמו"ר מויז\'ניץ במלחמת העצמאות? האם הרבי מקוצק כיבה את נרות השבת? ומה גילה מנהיג חב"ד לפרויד על ספת הפסיכולוג? ועוד מעשיות לא קדושות.',
  },
